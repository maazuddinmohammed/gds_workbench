...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(["0.1", ".2"], "DECIMAL(38,1)", id="decimal_fraction"),
        pytest.param(
            ["-9223372036854775808", "9223372036854775807"], "BIGINT", id="signed64_bounds"
        ),
        pytest.param(["9223372036854775808"], "DECIMAL(38,0)", id="signed64_overflow"),
        ...
        pytest.param(["999.1", ".123"], "DECIMAL(38,3)", id="decimal_union"),
        pytest.param(["0.00"], "DECIMAL(38,2)", id="decimal_zero_scale"),
        pytest.param(["100e-2"], "DECIMAL(38,2)", id="decimal_exponent_retained_scale"),
        ...
        pytest.param(["0.00001e39"], "DECIMAL(38,0)", id="large_exponent_small_mantissa"),
