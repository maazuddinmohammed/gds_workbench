...
1. Re-read authoritative Model revision or Metadata state. On mismatch, automatically create and install a fresh Snapshot, then reassess; never merge automatically.
