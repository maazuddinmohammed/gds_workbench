...
MANUAL_LOAD_SELECTIONS: list[tuple[str, str]] = [
    # ("foundational.xlsx", "Environment"),
    # ("foundational.xlsx", "SystemType"),
    # ("foundational.xlsx", "Zone"),
    # ("foundational.xlsx", "ConnectionType"),
    # ("foundational.xlsx", "ObjectType"),
    # ("foundational.xlsx", "ConnectionParameter"),
    # ("foundational.xlsx", "PurgePolicy"),
    # ("foundational.xlsx", "SystemNotebook"),
    # ("foundational.xlsx", "LocationType"),
    # ("foundational.xlsx", "FileType"),
    # ("foundational.xlsx", "Domain"),
    # ("foundational.xlsx", "DataOperation"),
    # ("foundational.xlsx", "ChunkType"),
    # ("foundational.xlsx", "Pipeline"),
    # ("foundational.xlsx", "ProcessType"),
    # ("foundational.xlsx", "Currency"),
    # ("foundational.xlsx", "JobType"),
    # ("foundational.xlsx", "Lane"),
    ...
    # ("tenant_modeling.xlsx", "Tenant"),
    # ("tenant_modeling.xlsx", "Connection"),
    # ("tenant_modeling.xlsx", "TenantMetadataDiscoveryScope"),
    # ("tenant_modeling.xlsx", "ConnectionLocation"),
    # ("tenant_modeling.xlsx", "ConnectionValue"),
    # ("tenant_modeling.xlsx", "Object"),
    # ("tenant_modeling.xlsx", "Attribute"),
    # ("tenant_modeling.xlsx", "IngestionObjectMapping"),
    # ("tenant_modeling.xlsx", "IngestionAttributeMapping"),
    # ("tenant_modeling.xlsx", "CopyGroup"),
    # ("tenant_modeling.xlsx", "MemberGroup"),
    # ("tenant_modeling.xlsx", "CopyGroupControl"),
    # ("tenant_modeling.xlsx", "Copy"),
    # ("tenant_modeling.xlsx", "ProcessGroup"),
    # ("tenant_modeling.xlsx", "Process"),
    # ("tenant_modeling.xlsx", "Model"),
    # ("tenant_modeling.xlsx", "ModelScope"),
    # ("locks.xlsx", "LockControl"),
]

_IDENTIFIER = re.compile(r"^[a-z][a-z0-9_]*$")
_ALLOWED_SCHEMAS = frozenset({"reference", "core", "security", "model"})
_ALLOWED_WORKBOOKS = frozenset({"foundational.xlsx", "users_security.xlsx", "tenant_modeling.xlsx"})
_ALLOWED_LOAD_TARGETS = {
    ("foundational.xlsx", "Environment"): ("reference", "environment"),
    ("foundational.xlsx", "SystemType"): ("reference", "system_type"),
    ("foundational.xlsx", "Zone"): ("reference", "zone"),
    ("foundational.xlsx", "ConnectionType"): ("reference", "connection_type"),
    ("foundational.xlsx", "ObjectType"): ("reference", "object_type"),
    ("foundational.xlsx", "ConnectionParameter"): (
        "reference",
        "connection_parameter",
    ),
    ("foundational.xlsx", "PurgePolicy"): ("reference", "purge_policy"),
    ("foundational.xlsx", "SystemNotebook"): ("reference", "system_notebook"),
    ("foundational.xlsx", "LocationType"): ("reference", "location_type"),
    ("foundational.xlsx", "FileType"): ("reference", "file_type"),
    ("foundational.xlsx", "Domain"): ("reference", "domain"),
    ("foundational.xlsx", "DataOperation"): ("reference", "data_operation"),
    ("foundational.xlsx", "ChunkType"): ("reference", "chunk_type"),
    ("foundational.xlsx", "Pipeline"): ("reference", "pipeline"),
    ("foundational.xlsx", "ProcessType"): ("reference", "process_type"),
    ("foundational.xlsx", "Currency"): ("reference", "currency"),
    ("foundational.xlsx", "JobType"): ("reference", "job_type"),
    ("foundational.xlsx", "Lane"): ("reference", "lane"),
    ...
    ("tenant_modeling.xlsx", "Tenant"): ("core", "tenant"),
    ("tenant_modeling.xlsx", "Connection"): ("core", "connection"),
    ("tenant_modeling.xlsx", "TenantMetadataDiscoveryScope"): (
        "core",
    ...
    ("tenant_modeling.xlsx", "ConnectionValue"): ("core", "connection_value"),
    ("tenant_modeling.xlsx", "Object"): ("core", "object"),
    ("tenant_modeling.xlsx", "Attribute"): ("core", "attribute"),
    ("tenant_modeling.xlsx", "IngestionObjectMapping"): (
        "core",
    ...
    ("tenant_modeling.xlsx", "CopyGroup"): ("core", "copy_group"),
    ("tenant_modeling.xlsx", "MemberGroup"): ("core", "member_group"),
    ("tenant_modeling.xlsx", "CopyGroupControl"): (
        "core",
        "copy_group_control",
    ),
    ("tenant_modeling.xlsx", "Copy"): ("core", "copy"),
    ("tenant_modeling.xlsx", "ProcessGroup"): ("core", "process_group"),
    ("tenant_modeling.xlsx", "Process"): ("core", "process"),
    ("tenant_modeling.xlsx", "Model"): ("model", "model"),
    ("tenant_modeling.xlsx", "ModelScope"): ("model", "model_scope"),
}
