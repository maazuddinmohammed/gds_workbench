...
# Run this cell first, then fill the Analysis Inference widgets above.
create_workflow_widgets("analysis_inference", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("analysis_inference", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
