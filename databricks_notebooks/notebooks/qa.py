...
# Run this cell first, then fill the QA widgets above.
create_workflow_widgets("qa", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("qa", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
