...
# Run this cell first, then fill the Analysis Validation widgets above.
create_workflow_widgets("analysis_validation", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("analysis_validation", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
