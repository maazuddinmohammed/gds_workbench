...
# Run this cell first, then fill the Mapping widgets above.
create_workflow_widgets("mapping", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("mapping", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
