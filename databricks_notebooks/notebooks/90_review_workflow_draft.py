...
# Run this cell first, then fill the draft review widgets above.
create_workflow_draft_review_widgets(dbutils=dbutils)

# COMMAND ----------

# Run this cell after filling every required widget.
run_workflow_draft_review_notebook(dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
