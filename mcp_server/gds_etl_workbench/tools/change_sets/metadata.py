    ...
    *,
    ...
    @server.tool(
        description=(
            ...
            "lists clear only that pending dataset. Use this only when the client can transfer "
            "the exact payload reliably; otherwise use Begin, Put, and Commit even below the "
            "1 MiB hard request limit. The draft revision increments once."
        ),
