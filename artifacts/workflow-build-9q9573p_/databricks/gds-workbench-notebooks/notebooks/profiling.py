...
# Run this cell first, then fill the profiling widgets above.
create_workflow_widgets("profiling", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("profiling", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
