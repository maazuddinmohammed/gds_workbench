...
# Run this cell first, then fill the Code Generation widgets above.
create_workflow_widgets("code_generation", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)

# COMMAND ----------

# Run this cell after filling every required widget.
run_notebook("code_generation", dbutils=dbutils, uploaded_root=_UPLOAD_ROOT)
