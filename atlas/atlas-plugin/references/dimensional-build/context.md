...
7. Start/reuse Workbench through its verified launcher. Use the existing task for decisions, coverage and unresolved questions; no new bus-matrix dataset, interview transcript or handoff ledger is required.
