...
Agreed release boundary. Design decisions are closed; implementation proceeds one verified slice at a time. The package supplies local runtime, Workbench and companion extension; installed backend compatibility is checked separately.
