...
6. Show the proposed artifact list and a small representative structure. Reuse prior decisions; ask only about unresolved choices or material exceptions. This preview does not replace review of the final content before Stage/Apply. Start/reuse Workbench through its verified launcher.
