...
6. Before completing the request, review coherence and coverage across all requested parts, including shared Entities and cross-part relationships. Partial progress remains explicit. Follow the shared [Change Set lifecycle](../../references/change-set-lifecycle.md) for the complete related batch or a required applied dependency; a question, answer or part boundary does not trigger Stage/Apply.
