(function (root, factory) {
  ...
  const sql = typeof module === "object" && module.exports ? require("./sql.js") : root.AtlasSql;
  const api = factory(core, sql);
  if (typeof module === "object" && module.exports) module.exports = api;
  root.GDSModelValidation = api;
})(typeof globalThis === "object" ? globalThis : this, function (core, sql) {
  "use strict";

  const { validateReadSql } = sql;
