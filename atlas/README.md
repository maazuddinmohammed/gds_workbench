...
Use Node.js 20+ and Python 3.12+ for the main local runtime. A native Windows PowerShell 5.1 fallback is included. Workbench uses Chrome/Edge directory access. Read the [runtime guide](atlas-plugin/docs/runtime-guide.md), [user guide](atlas-plugin/docs/user-guide.md), [validation index](atlas-plugin/docs/validation-index.md) and [release scope](atlas-plugin/references/release-scope.md).
