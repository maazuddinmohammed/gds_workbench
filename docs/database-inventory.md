...
- `guard_workflow_run_system_selection` on `application.workflow_run_system_selection` — UPDATE/DELETE, row. Steps: (1) intercept; (2) raise unconditionally; (3) keep selected Systems immutable.
