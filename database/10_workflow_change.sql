...
CREATE TRIGGER guard_metadata_change_set_transition BEFORE UPDATE
ON workflow.metadata_change_set FOR EACH ROW
EXECUTE FUNCTION workflow.guard_metadata_change_set_transition();

CREATE TRIGGER guard_change_set_event_append_only BEFORE UPDATE OR DELETE
ON workflow.model_change_set_event FOR EACH ROW EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_idempotency_outcome_append_only BEFORE UPDATE OR DELETE
ON workflow.idempotency_outcome FOR EACH ROW EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_apply_receipt_append_only BEFORE UPDATE OR DELETE
ON workflow.model_apply_receipt FOR EACH ROW EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_apply_receipt_ref_append_only BEFORE UPDATE OR DELETE
ON workflow.model_apply_receipt_ref FOR EACH ROW EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_metadata_change_set_event_append_only BEFORE UPDATE OR DELETE
ON workflow.metadata_change_set_event FOR EACH ROW
EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_metadata_apply_receipt_append_only BEFORE UPDATE OR DELETE
ON workflow.metadata_apply_receipt FOR EACH ROW
EXECUTE FUNCTION security.reject_append_only_change();

CREATE TRIGGER guard_metadata_apply_receipt_ref_append_only BEFORE UPDATE OR DELETE
ON workflow.metadata_apply_receipt_ref FOR EACH ROW
EXECUTE FUNCTION security.reject_append_only_change();
